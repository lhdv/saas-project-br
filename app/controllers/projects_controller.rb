class ProjectsController < ApplicationController
  ...
  def users
    @project_users = (@project.users + (User.where(tenand_id: @tenant_id, is_admin: true))) - [current_user]  
    @other_users = @tenant.users.where(tenand_id: @tenant.id, is_admin: false) - (@project_users + [current_user])
  end
